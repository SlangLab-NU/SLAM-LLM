...
output_dir=/work/van-speech-nlp/jindaznb/jslpnb/mllm_expriments/slam-llm/out/train/ami_pho_mono-20240819
ckpt_path=$output_dir/asr_epoch_3_step_10768
...
python $code_dir/scripts/wer.py \
        --folder /work/van-speech-nlp/jindaznb/jslpnb/mllm_expriments/slam-llm/out/train/ami_wavlm_mono-20240819